...
#               flow=SampleProcessing("VBF Hmumu Analysis","/scratchssd/sdonato/fileSkimFromNanoAOD/PROD_12_0/vbfHmm_"+year+"AMCPY.root")
               flow=SampleProcessing("VBF Hmumu Analysis","/home/sdonato/fileSkimFromNanoAOD/PROD_12_0/vbfHmm_"+year+"AMCPY.root")
            else:
        ...
        ##FIXME## SD
#        flow=SampleProcessing("VBF Hmumu Analysis","/home/sdonato/fileSkimFromNanoAOD/PROD_13_4/vbfHmm_2026POWPYDIPOLE.root") #/scratch/mandorli/Hmumu/fileSkimFromNanoAOD/fileSkim2016_tmp/VBF_HToMuMu_nano2016.root")
...
#  flow.Define("SelectedMuon_GFp4","Where((Muon_FSR_pt == 0.),SelectedMuon_p4GFcorr,SelectedMuon_p4)")
        ...
        flow.AddExternalCode(header= "eval_lwtnn.h",cppfiles=["eval_lwtnn.C"],libs=["lwtnn"],ipaths=["/home/sdonato/nail/PisaHmm/lwtnn/include/lwtnn/"],lpaths=["/home/sdonato/nail/PisaHmm/lwtnn/build/lib/"]) ##FIXME hard-code library
