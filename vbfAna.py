...
##FIXME Hard coded ###
ROOT.gInterpreter.AddIncludePath("/home/sdonato/nail/PisaHmm/lwtnn/include/lwtnn") 
ROOT.gSystem.Load("/home/sdonato/nail/PisaHmm/lwtnn/build/lib/liblwtnn.so")
...
#           rdf=rdf.Define("PrefireWeight","1.0f")
         ...
         print "Samples", s, samples[s].keys()
         if "lumi" in samples[s].keys() :
               ou=procData(rdf)
         else :
            ou=proc(rdf)
