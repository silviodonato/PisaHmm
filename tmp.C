...
auto rdf71 =rdf70.DefineSlot("twoJetsWeight__Central",func__twoJetsWeight__Central,{});
auto rdf72 =rdf71.DefineSlot("twoMuons_twoOppositeSignMuons_twoJets_VBFRegion_PreSelWeight__Central",func__twoMuons_twoOppositeSignMuons_twoJets_VBFRegion_PreSelWeight__Central,{});
...
auto rdf76 =rdf75.DefineSlot("twoMuons_twoOppositeSignMuons_twoJets_VBFRegionWeight__Central",func__twoMuons_twoOppositeSignMuons_twoJets_VBFRegionWeight__Central,{});
...
auto toplevel=rdf81;
std::vector<ROOT::RDF::RResultPtr<TH1D>> histos;
{}auto selection_SignalRegionPhase1=rdf81.Filter("twoMuons","twoMuons").Filter("twoOppositeSignMuons","twoOppositeSignMuons").Filter("twoJets","twoJets").Filter("VBFRegion","VBFRegion").Filter("PreSel","PreSel").Filter("SignalRegionPhase1","SignalRegionPhase1");
